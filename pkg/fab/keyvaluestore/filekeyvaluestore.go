...
func (fkvs *FileKeyValueStore) Load(key interface{}) (interface{}, error) {
	//nodelog.Logs("[Enroll] FileKeyValueStore Load In")
	//nodelog.Logs("[Enroll] FileKeyValueStore Load Key:",key)
...
func (fkvs *FileKeyValueStore) Store(key interface{}, value interface{}) error {
	//nodelog.Logs("[Enroll] FileKeyValueStore Store In")
	//nodelog.Logs("[Enroll] FileKeyValueStore Store Key:",key)
	if key == nil {
